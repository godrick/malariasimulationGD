...
test_that('mixing_fn can return isolated transmission for multiple species', {
  ...
  expect_equal(
    ...
    list(
      ...
      transmission_eir = t(matrix(c(rep(10, 3), rep(20, 3)), nrow=3, ncol=2)),
      inf = c(.1, .2)
    )
  )
})
...
test_that('mixing_fn can return asymmetric transmission', {
  ...
  expect_equal(
    ...
    list(
      ...
      transmission_eir = matrix(c(15, 15), nrow=2, ncol=1),
      inf = c(.1, .2)
    )
  )
})
...
test_that('mixing_fn can halve the mixed transmission for 50% rdt detection', {
  ...
  expect_equal(
    ...
    list(
      ...
      transmission_eir = matrix(c(10, 12.5), nrow=2, ncol=1),
      inf = c(.075, .150)
    )
  )
})
...
test_that('mixing_fn can completely remove mixed transmission', {
  ...
  expect_equal(
    ...
    list(
      ...
      transmission_eir = matrix(c(5, 10), nrow=2, ncol=1),
      inf = c(.05, .1)
    )
  )
})
